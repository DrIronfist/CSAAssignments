...
public class GuessingGame
{
	...
	public int getMin()
	{	
		return myMin; // TODO: Implement this method (see algorithm above)
	}
	...
	public int getMax()
	{
		return myMax; // TODO: Implement this method (see algorithm above)
	}
	...
	public String testGuess(int guess)
	{
		...
		return result; // TODO: Implement this method (see algorithm above)
	}
	 ...
	 *                myMin <= myMax
	 * postcondition: Returns a random integer in the range of [myMin, myMax].
	...
	private int getSecretNumber()
	{
		...
		return (int)(Math.random()*range) + myMin; // TODO: Implement this method (see algorithm above)
	}
