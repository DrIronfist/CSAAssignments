...
public class GuessingGameDriver
{
	 ...
	 *                  chooseMin() method, passing it a reference to kin as a 
	 *                  parameter.
	 *                Declare an integer variable called max and initialize it 
	 *                  with the result of invoking the GuessingGameDriver class'
	 *                  chooseMax() method, passing it a reference to kin as a 
	 *                  parameter.
	...
	{
		System.out.println("Enter minimum value for the game's range");
		return kin.nextInt(); // TODO: Implement this method (see algorithm above)
	}
	...
	{
		System.out.println("Enter maximum value for the game's range");
		return kin.nextInt(); // TODO: Implement this method (see algorithm above)
	}
